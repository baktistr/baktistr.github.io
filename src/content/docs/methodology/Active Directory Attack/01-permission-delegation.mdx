...
Two paths: **LAPS** (if deployed) or **RBCD**. Always check LAPS first — it's one command vs. four steps.

**Fast path — LAPS (see the full LAPS section below):**
...
**Fallback — RBCD from Windows (PowerView):**
...
**Fallback — Full RBCD chain from Linux:**
